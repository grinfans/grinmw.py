...
class TestForeignApiV2Methods(GrinAPITestClass):
    def test_check_version(self):
        with requests_mock.Mocker() as m:
            client_foreign = WalletV2Foreign("http://localhost:3415/v2/foreign")
    ...
    def test_build_coinbase(self):
        with requests_mock.Mocker() as m:
            ...
            expected_request_body = {
                ...
                "id": 1,
                "method": "",
                "params": [{"fees": fees, "height": height, "key_id": key_id}],
            }
            mocked_response_result = {
                "kernel": {
            ...
            result = client_foreign.build_coinbase(fees, height, key_id=key_id)
            assert result == mocked_response_result
